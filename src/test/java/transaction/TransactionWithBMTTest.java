...
import transaction.bean.MyBeanWithBMT;

@RunWith(Arquillian.class)
public class TransactionWithBMTTest
{
    ...
    public static JavaArchive createDeployment()
    {
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class)
                .addClasses(MyBeanWithBMT.class, MyBeanRemote.class, ContaCorrente.class, MyException.class)
    ...
    public void test() throws Exception
    {
        ...
        try {
            ...
            Assert.assertEquals("BMT", ((MyException)e).getMethod());
            conta1 = myBean.selecionarContaCorrente(1);
            Assert.assertEquals(5, conta1.getSaldo().intValue());
        }
    }
